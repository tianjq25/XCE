...
class PlansManager:
    ...
    def get_node(self, plan_id, plan_node_id):
        try:
            ...
            print(f"plan_id: {plan_id}, plan_node_id: {plan_node_id} not found")
            print(self.plan_id_to_node_id_to_node)
            for plan_node in self.plans[plan_id].get_all_nodes():
                # plan_id = plan_node.plan_id
                node_id = plan_node.node_id
                node_type = plan_node.node_type
                print(f"plan_id: {plan_id}, node_id: {node_id}, node_type: {node_type}")
            raise 
